...
public:		//-------------------------------------- 变量部分 ----------------------------------
	...
	const char	*	m_pAsmError;            // Explanation of last error, or NULL
...
//-------------------------------------------------------------------------------------------------------------------------
//全局变量声明:
extern	const char	*	g_szSegName[8];
extern	const char	*	g_szRegName[3][9];
extern	const char	*	g_szCRName[9];
extern	const char	*	g_szDRName[9];
extern	const char	*	g_szFPUName[9];
extern	const char	*	g_szMMXName[9];

//
extern	const char	*	g_szSizeName[11];
