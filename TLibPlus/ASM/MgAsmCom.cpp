// MgAsmCom.cpp: implementation of the CMgAsmBase class.
//
//////////////////////////////////////////////////////////////////////
...
//
const char *	g_szSegName[8] = { "ES","CS","SS","DS","FS","GS","SEG?","SEG?" };


//
const char *	g_szCRName[9] = { "CR0","CR1","CR2","CR3","CR4","CR5","CR6","CR7","CRX" };

//
const char *	g_szDRName[9] = { "DR0","DR1","DR2","DR3","DR4","DR5","DR6","DR7","DRX" };

//
const char *	g_szFPUName[9] = { "ST0","ST1","ST2","ST3","ST4","ST5","ST6","ST7","FPU" };

//
const char *	g_szMMXName[9] = { "MM0","MM1","MM2","MM3","MM4","MM5","MM6","MM7","MMX" };


//
const char *	g_szSizeName[11] = 
{	
...
// Decoding of VxD calls (Win95/98)
t_cmddata		g_VxdCmd = { 0x00FFFF, 0x0020CD, 2,00,  VXD,NNN,NNN, C_CAL+C_RARE+0, "VxDCall" };
